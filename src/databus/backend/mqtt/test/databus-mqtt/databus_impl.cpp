...
namespace poker::databus_impl
{
    ...
    //
    //        return databus_impl::http::Call< channel_method< channel::MyServiceChannel >::type, int, int >(channel,
    //        req);
    //    }
    //
    //    /**
    ...
    //     */
    //    template <>
    //    AuxDeleter Serve< int, int, tag::MyTag >(const databus::XChannelType &channel, const Server< int, int >
    //    &server)
    //    {
